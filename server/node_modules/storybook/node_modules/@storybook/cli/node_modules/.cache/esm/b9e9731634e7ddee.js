let path,fs,chalk,spawnSync,gt,satisfies,latestVersion,version,devDependencies;_34e‍.x([["getVersion",()=>getVersion],["getVersions",()=>getVersions],["getPackageJson",()=>getPackageJson],["getBowerJson",()=>getBowerJson],["readFileAsJson",()=>readFileAsJson],["writeFileAsJson",()=>writeFileAsJson],["writePackageJson",()=>writePackageJson],["writeBabelRc",()=>writeBabelRc],["commandLog",()=>commandLog],["paddedLog",()=>paddedLog],["getChars",()=>getChars],["codeLog",()=>codeLog],["installDepsFromPackageJson",()=>installDepsFromPackageJson],["installDependencies",()=>installDependencies],["getBabelDependencies",()=>getBabelDependencies],["addToDevDependenciesIfNotPresent",()=>addToDevDependenciesIfNotPresent]]);_34e‍.w("path",[["default",["path"],function(v){path=v}]]);_34e‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_34e‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_34e‍.w("cross-spawn",[["sync",["spawnSync"],function(v){spawnSync=v}]]);_34e‍.w("semver",[["gt",["gt"],function(v){gt=v}],["satisfies",["satisfies"],function(v){satisfies=v}]]);_34e‍.w("./latest_version",[["default",["latestVersion"],function(v){latestVersion=v}]]);_34e‍.w("../package.json",[["version",["version"],function(v){version=v}],["devDependencies",["devDependencies"],function(v){devDependencies=v}]]);/* eslint-disable no-param-reassign */
...
const logger = _34e‍.g.console;
       ...
       async function getVersion(npmOptions, packageName, constraint) {
  let current;
  ...
  return `^${versionToUse}`;
       ...
       function getVersions(npmOptions, ...packageNames) {
  ...
  return JSON.parse(jsonContent);
       ...
       function readFileAsJson(jsonPath) {
  ...
  logger.log(finalResult);
       ...
       function installDepsFromPackageJson(options) {
 ...
 * ]);
 */
       function installDependencies(npmOptions, dependencies) {
 ...
 * ]);
 */
       async function getBabelDependencies(npmOptions, packageJson) {
